...
class DefaultSelect implements Select {
    ...
    private final List<GroupByField> groupBy;
    ...
    DefaultSelect(boolean distinct, List<Expression> selectList, List<TableLike> from, long limit, long offset,
                  List<Join> joins, @Nullable Condition where, List<OrderByField> orderBy, List<GroupByField> groupBy, @Nullable LockMode lockMode) {
    ...
    public void visit(Visitor visitor) {
        ...
        groupBy.forEach(it -> it.visit(visitor));
